...
Namespace SaveComponents
	...
	Private Sub report_SaveComponents(ByVal sender As Object, ByVal e As SaveComponentsEventArgs)
		Dim tableAdapterIdx As Integer = GetItemIndex(e.Components, GetType(Component))
	...
	Private Shared Function GetItemIndex(ByVal components As IList, ByVal targetType As Type) As Integer
